...
class SpectralBranch(nn.Module):
    def __init__(self, in_channels):
        super().__init__()
        self.conv_input = MultiScaleConv3D(in_channels, 128)
...
class SpatialBranch(nn.Module):
    def __init__(self, in_channels, embed_dim=128, num_heads=4, num_layers=2):
        ...
        self.conv_input = MultiScaleConv2D(in_channels, embed_dim)

        self.fuse_guided = nn.Conv2d(1 + embed_dim, embed_dim, kernel_size=1)
